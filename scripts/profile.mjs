...
// Vendored so the bundle needs no npm install. .cjs because this package is
// "type": "module" and papaparse.min.js is UMD.
import Papa from '../assets/vendor/papaparse.min.cjs';
